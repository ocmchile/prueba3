...
class UserSongsControllerTest < ActionController::TestCase
  ...
  test "should create user_song" do
    assert_difference('UserSong.count') do
      post :create, user_song: { position: @user_song.position, song_id: @user_song.song_id, user_id: @user_song.user_id }
    end
  ...
  test "should update user_song" do
    patch :update, id: @user_song, user_song: { position: @user_song.position, song_id: @user_song.song_id, user_id: @user_song.user_id }
    assert_redirected_to user_song_path(assigns(:user_song))
  end
